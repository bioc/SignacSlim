...
RcppExport SEXP _SignacSlim_filterCells(SEXP fragmentsSEXP, SEXP outfileSEXP, SEXP keep_cellsSEXP, SEXP buffer_lengthSEXP, SEXP verboseSEXP) {
BEGIN_RCPP
...
RcppExport SEXP _SignacSlim_groupCommand(SEXP fragmentsSEXP, SEXP some_whitelist_cellsSEXP, SEXP max_linesSEXP, SEXP verboseSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< std::string >::type fragments(fragmentsSEXP);
...
RcppExport SEXP _SignacSlim_splitFragments(SEXP fragmentsSEXP, SEXP cellsSEXP, SEXP identsSEXP, SEXP unique_identsSEXP, SEXP outdirSEXP, SEXP suffixSEXP, SEXP buffer_lengthSEXP, SEXP appendSEXP, SEXP verboseSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< std::string >::type fragments(fragmentsSEXP);
...
RcppExport SEXP _SignacSlim_validateCells(SEXP fragmentsSEXP, SEXP cellsSEXP, SEXP find_nSEXP, SEXP max_linesSEXP, SEXP verboseSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< std::string >::type fragments(fragmentsSEXP);
...
static const R_CallMethodDef CallEntries[] = {
    {"_SignacSlim_filterCells", (DL_FUNC) &_SignacSlim_filterCells, 5},
    {"_SignacSlim_groupCommand", (DL_FUNC) &_SignacSlim_groupCommand, 4},
    {"_SignacSlim_splitFragments", (DL_FUNC) &_SignacSlim_splitFragments, 9},
    {"_SignacSlim_validateCells", (DL_FUNC) &_SignacSlim_validateCells, 5},
    {NULL, NULL, 0}
};

RcppExport void R_init_SignacSlim(DllInfo *dll) {
